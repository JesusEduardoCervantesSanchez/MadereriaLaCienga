...
public class ModificarProveedor extends javax.swing.JPanel {
    ...
    public void comboProv(){
        cmbClave.setModel(control.seleccionarProveedores(2));
    }
    
     public void MensajeOK(String mensaje)
    {
        JOptionPane.showMessageDialog(this, mensaje, "Modificar Proveedor", JOptionPane.INFORMATION_MESSAGE);
    }
    
    public void MensajeError(String mensaje)
    {
        JOptionPane.showMessageDialog(this, mensaje, "Modificar Proveedor", JOptionPane.ERROR_MESSAGE);
    }
    ...
    private void btnAceptarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAceptarActionPerformed
       ...
       if(accion.equals("Elige")){
           JOptionPane.showMessageDialog(this, "Debe elegir el id del proveedor a modificar", "Modificar Proveedor", JOptionPane.WARNING_MESSAGE);
           txtNombre.requestFocus();
           return;
        }
       if(txtNombre.getText().isBlank()){
           JOptionPane.showMessageDialog(this, "Debe ingresar el nombre del proveedor", "Modificar Proveedor", JOptionPane.WARNING_MESSAGE);
           txtNombre.requestFocus();
           return;
       }
       if(txtDireccion.getText().isBlank()){
          JOptionPane.showMessageDialog(this, "Debe ingresar la direccion del proveedor", "Modificar Proveedor", JOptionPane.WARNING_MESSAGE);
          txtDireccion.requestFocus();
          return;
       }
       if(txtEstado.getText().isBlank()){
           JOptionPane.showMessageDialog(this, "Debe ingresar el estado del proveedor", "Modificar Proveedor", JOptionPane.WARNING_MESSAGE);
           txtEstado.requestFocus();
           return;
       }
       if(txtTelefono.getText().isBlank()){
           JOptionPane.showMessageDialog(this, "Debe ingresar el telefono del proveedor", "Modificar Proveedor", JOptionPane.WARNING_MESSAGE);
           txtTelefono.requestFocus();
           return;
       }
       if(txtLocalidad.getText().isBlank()){
           JOptionPane.showMessageDialog(this, "Debe ingresar la localidad del proveedor", "Modificar Proveedor", JOptionPane.WARNING_MESSAGE);
           txtLocalidad.requestFocus();
           return;
       }
       resp=control.Actualizar(Integer.parseInt(cmbClave.getSelectedItem()+""), nombreant, txtNombre.getText().trim(), txtDireccion.getText().trim(), txtEstado.getText().trim(), txtTelefono.getText().trim(), txtLocalidad.getText());
        if(resp.equals("OK")){
            MensajeOK("Proveedor modificado exitosamente");
            Limpiar();
        }else{
            MensajeError(resp);
        }
    ...
    private void cmbClaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmbClaveActionPerformed
        ...
        if(!accion.equals("Elige")){
            ...
            txtNombre.setText(arreglo[0]);
            txtDireccion.setText(arreglo[1]);
            txtEstado.setText(arreglo[2]);
            txtTelefono.setText(arreglo[3]);
            txtLocalidad.setText(arreglo[4]);
